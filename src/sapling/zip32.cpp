...
const unsigned char  EVO_Nodes_HD_SEED_FP_PERSONAL[crypto_generichash_blake2b_PERSONALBYTES] =
    {'P', 'I', 'V', 'X', '_', '_', 'H', 'D', '_', 'S', 'e', 'e', 'd', '_', 'F', 'P'};

const unsigned char  EVO_Nodes_TADDR_OVK_PERSONAL[crypto_generichash_blake2b_PERSONALBYTES] =
...
{
    CBLAKE2bWriter h(SER_GETHASH, 0,  EVO_Nodes_HD_SEED_FP_PERSONAL);
    h << seed;
    return h.GetHash();
}
...
uint256 ovkForShieldingFromTaddr(HDSeed& seed) {
    ...
    assert(crypto_generichash_blake2b_init_salt_personal(
            ...
            64,
            nullptr,    // No salt.
             EVO_Nodes_TADDR_OVK_PERSONAL) == 0);
