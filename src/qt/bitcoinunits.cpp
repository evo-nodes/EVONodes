...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(EVO);
    unitlist.append(mEVO);
    unitlist.append(uEVO);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case EVO:
        return QString("evo_nodes");
    case mEVO:
        return QString("mevo_nodes");
    case uEVO:
        return QString::fromUtf8("uevo_nodes");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZevo)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZEVO)
{
    QSettings settings;
...
QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZEVO)
{
