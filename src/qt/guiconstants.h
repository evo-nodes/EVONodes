...
/* EVO_Nodes GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "EVO_Nodes"
#define QAPP_ORG_DOMAIN "evo_nodes.org"
#define QAPP_APP_NAME_DEFAULT "EVO_Nodes-Qt"
#define QAPP_APP_NAME_TESTNET "EVO_Nodes-Qt-testnet"
