...
#ifndef  EVO_Nodes_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define  EVO_Nodes_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif // EVO_Nodes_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
