...
#include "qt/evo_nodes/forms/ui_masternodewizarddialog.h"
    ...
    mnModel(_mnModel)
{
    ...
    ui->labelMessage1a->setText(formatHtmlContent(
                formatParagraph(tr("To create a EVO Nodes Masternode you must dedicate %1 (the unit of EVO Nodes) "
