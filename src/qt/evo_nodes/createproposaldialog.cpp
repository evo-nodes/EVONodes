...
#include "qt/evo_nodes/createproposaldialog.h"
#include "qt/evo_nodes/forms/ui_createproposaldialog.h"
...
CreateProposalDialog::CreateProposalDialog( EVO_NodesGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.evo_nodes/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 EVO");
...
void CreateProposalDialog::onAddrListClicked()
{
    ...
    if (!menuContacts) {
        ...
        menuContacts = new ContactsDropdown(
                width,
                height,
                dynamic_cast< EVO_NodesGUI*>(parent()),
                this
        );
