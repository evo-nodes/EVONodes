...
#include "qt/evo_nodes/sendcustomfeedialog.h"
#include "qt/evo_nodes/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog( EVO_NodesGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, & EVO_NodesGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
