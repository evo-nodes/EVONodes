...
#include "qt/evo_nodes/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight,  EVO_NodesGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{
