...
#ifndef  EVO_Nodes_CORE_NEW_GUI_EVO_NodesGUI_H
#define  EVO_Nodes_CORE_NEW_GUI_EVO_NodesGUI_H
...
#include "qt/evo_nodes/navmenuwidget.h"
#include "qt/evo_nodes/topbar.h"
#include "qt/evo_nodes/dashboardwidget.h"
#include "qt/evo_nodes/send.h"
#include "qt/evo_nodes/receivewidget.h"
#include "qt/evo_nodes/addresseswidget.h"
#include "qt/evo_nodes/coldstakingwidget.h"
#include "qt/evo_nodes/governancewidget.h"
#include "qt/evo_nodes/masternodeswidget.h"
#include "qt/evo_nodes/snackbar.h"
#include "qt/evo_nodes/settings/settingswidget.h"
...
/**
  EVO_Nodes GUI main class. This class represents the main window of the EVO_Nodes UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class  EVO_NodesGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit  EVO_NodesGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~ EVO_NodesGUI();
...
#endif // EVO_Nodes_CORE_NEW_GUI_ EVO_NodesGUI_H
