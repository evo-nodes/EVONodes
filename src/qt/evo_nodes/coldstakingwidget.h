...
#include "qt/evo_nodes/furabstractlistitemdelegate.h"
#include "qt/evo_nodes/txviewholder.h"
#include "qt/evo_nodes/tooltipmenu.h"
#include "qt/evo_nodes/sendmultirow.h"
#include "qt/evo_nodes/coldstakingmodel.h"
...
public:
    explicit ColdStakingWidget( EVO_NodesGUI* parent);
    ~ColdStakingWidget();
