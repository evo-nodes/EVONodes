...
#include "qt/evo_nodes/forms/ui_masternodeswidget.h"

#include "qt/evo_nodes/qtutils.h"
#include "qt/evo_nodes/mnrow.h"
#include "qt/evo_nodes/mninfodialog.h"
#include "qt/evo_nodes/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget( EVO_NodesGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= mnCollateralAmount) {
        inform(tr("Not enough balance to create a masternode, %1 required.")
            .arg(GUIUtil::formatBalance(mnCollateralAmount, BitcoinUnits::EVO)));
        return;
    }
