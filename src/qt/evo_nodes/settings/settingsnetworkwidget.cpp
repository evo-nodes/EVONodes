...
#include "qt/evo_nodes/settings/settingsnetworkwidget.h"
#include "qt/evo_nodes/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/evo_nodes/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget( EVO_NodesGUI* _window, QWidget *parent) :
