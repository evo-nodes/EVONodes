...
#include "qt/evo_nodes/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/evo_nodes/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget( EVO_NodesGUI* _window, QWidget *parent) :
