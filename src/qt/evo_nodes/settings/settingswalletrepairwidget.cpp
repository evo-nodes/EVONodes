...
#include "qt/evo_nodes/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/evo_nodes/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget( EVO_NodesGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to  EVO_NodesGUI::handleRestart()
