...
#include "qt/evo_nodes/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget( EVO_NodesGUI* _window,QWidget *parent) :
