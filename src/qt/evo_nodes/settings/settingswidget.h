...
#include "qt/evo_nodes/settings/settingsbackupwallet.h"
#include "qt/evo_nodes/settings/settingsexportcsv.h"
#include "qt/evo_nodes/settings/settingsbittoolwidget.h"
#include "qt/evo_nodes/settings/settingssignmessagewidgets.h"
#include "qt/evo_nodes/settings/settingswalletrepairwidget.h"
#include "qt/evo_nodes/settings/settingswalletoptionswidget.h"
#include "qt/evo_nodes/settings/settingsmainoptionswidget.h"
#include "qt/evo_nodes/settings/settingsdisplayoptionswidget.h"
#include "qt/evo_nodes/settings/settingsinformationwidget.h"
#include "qt/evo_nodes/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget( EVO_NodesGUI* parent);
    ~SettingsWidget();
