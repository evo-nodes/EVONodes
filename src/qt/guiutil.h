...
/** Utility functions used by the EVO_Nodes Qt UI.
 */
namespace GUIUtil
{
...
// Render EVO_Nodes addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZevo = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZevo = false);
...
// Parse "evo_nodes:" URI into recipient object, return true on successful parsing
