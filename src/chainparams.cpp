...
{
    const char* pszTimestamp = "DePIN use blockchains to incentivize communities to create a wide range of shared real world services";
    const CScript genesisOutputScript = CScript() << ParseHex("04c10d83c2303ddc322a7dcd62dd2815ab7c10db058214cd121bc72607d57ab7810c02c05b2aed04b4deb9c4b7cb26c92428c61e56ad42774ba5ba0a023b5ee0a4") << OP_CHECKSIG;
...
static MapCheckpoints mapCheckpoints = {
    {0, uint256S("0x000004af4c52f89326907c3d87eff411ed1596580918936e887af7eb4bcd63fc")},
    {2561, uint256S("0x71861d7873759bdb645e6e5b33cd739b06f0a7e6e6ba26bf731f59bf4336e193")},
    {5684, uint256S("0x600dc323177244f486359948c06b8b232ab880857b79dc890b731867a7857ed6")},
    {8630, uint256S("0x03d7ca07939e6eef1b11cb9eb8e9de9fc05064914cb68423d09526eec5c4d103")},
};

static const CCheckpointData data = {
    &mapCheckpoints,
    1721195925, // * UNIX timestamp of last checkpoint block
    17271,      // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1720611199, 122682, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000004af4c52f89326907c3d87eff411ed1596580918936e887af7eb4bcd63fc"));
        assert(genesis.hashMerkleRoot == uint256S("0xa2ff92ca5a06d42b09ff15a55e9a4598d6d698cb4f9d74c9cbf80e45c403497d"));
        ...
        // spork keys
        consensus.strSporkPubKey = "04a2c82f766b650aff4d493682a6799075b51955d13ac0aacb52e576d172cdc10465ca1957d066f195ce7b8f6bbd9d82e24700e92f9c7c981dcf03b1275eac594b";
        consensus.strSporkPubKeyOld = "04a2c82f766b650aff4d493682a6799075b51955d13ac0aacb52e576d172cdc10465ca1957d066f195ce7b8f6bbd9d82e24700e92f9c7c981dcf03b1275eac594b";
        consensus.nTime_EnforceNewSporkKey = 1720611199; //!> Wednesday, July 10, 2024 5:03:19 PM GMT+05:30
        consensus.nTime_RejectOldSporkKey = 1720871607;  //!> Saturday, July 13, 2024 5:23:27 PM GMT+05:30
        ...
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].nActivationHeight          = 550;
        consensus.vUpgrades[Consensus::UPGRADE_V5_0].nActivationHeight          = 800;
        consensus.vUpgrades[Consensus::UPGRADE_V5_2].nActivationHeight          = 800;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_V5_6].nActivationHeight          = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        ...
        vSeeds.emplace_back("209.38.22.238", true);     // Primary DNS Seeder from Fuzzbawls
        vSeeds.emplace_back("64.225.77.31", true);
        vSeeds.emplace_back("134.122.49.134", true);
        vSeeds.emplace_back("64.225.66.129", true);
        vSeeds.emplace_back("64.227.78.147", true);
        vSeeds.emplace_back("64.225.77.0", true);
        ...
        // Sapling
        bech32HRPs[SAPLING_PAYMENT_ADDRESS]      = "ev";
        bech32HRPs[SAPLING_FULL_VIEWING_KEY]     = "pviews";
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "evoks";
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("evo_nodes-testnet.seed.fuzzbawls.pw", true);
        vSeeds.emplace_back("evo_nodes-testnet.seed2.fuzzbawls.pw", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet evo_nodes addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet evo_nodes script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[EXCHANGE_ADDRESS] = {0x01, 0xb9, 0xb1};   // EXT prefix for the address
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet evo_nodes BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x3a, 0x80, 0x61, 0xa0};
        // Testnet evo_nodes BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = {0x3a, 0x80, 0x58, 0x37};
        // Testnet evo_nodes BIP44 coin type is '1' (All coin's testnet default)
