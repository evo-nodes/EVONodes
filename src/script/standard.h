 ...
 *  A CTxDestination is the internal data type encoded in a EVO_Nodes address
 */
...
/**
 * Generate a EVO_Nodes scriptPubKey for the given CTxDestination. Returns a P2PKH
