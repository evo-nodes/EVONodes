...
public:
    ...
    /**
     * Amount of evo_nodes coming in to a transaction
...
// EVO_Nodes: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
