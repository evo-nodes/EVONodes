...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " evo_nodes-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  evo_nodes-tx [options] <hex-tx> [commands]  Update hex-encoded evo_nodes transaction\n" +
                               "or:     evo_nodes-tx [options] -create [commands]   Create hex-encoded evo_nodes transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded evo_nodes transaction
