...
extern const char * const  EVO_Nodes_CONF_FILENAME;
extern const char * const  EVO_Nodes_PID_FILENAME;
extern const char * const  EVO_Nodes_MASTERNODE_CONF_FILENAME;
