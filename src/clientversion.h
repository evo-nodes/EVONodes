...
#error Client version information missing: version is not defined by evo_nodes-config.h or in any other way
#endif
...
/**
 * evo_nodesd-res.rc includes this file, but it cannot cope with real c++ code.
