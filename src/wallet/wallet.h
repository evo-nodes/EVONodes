...
#ifndef  EVO_Nodes_WALLET_H
#define  EVO_Nodes_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_EVO_Nodes = 61000, // inherited version..
...
public:
     ...
     * EVO_Nodes: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 EVO output and keys which can be used for the Masternode
    ...
    bool CreateCoinstakeOuts(const CEvoStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;
