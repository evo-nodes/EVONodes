...
#ifndef  EVO_Nodes_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define  EVO_Nodes_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif //  EVO_Nodes_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
