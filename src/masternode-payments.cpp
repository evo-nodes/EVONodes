...
bool IsBlockPayeeValid(const CBlock& block, const CBlockIndex* pindexPrev)
{
    ...
    if (nBlockHeight == 20000 || nBlockHeight == 70000 || nBlockHeight == 110000 || nBlockHeight == 150000 || nBlockHeight == 200000 || nBlockHeight == 230000 || nBlockHeight == 260000 || nBlockHeight == 300000 || nBlockHeight == 350000 || nBlockHeight == 400000 || nBlockHeight == 500000 || nBlockHeight == 600000 || nBlockHeight == 700000 || nBlockHeight == 800000 || nBlockHeight == 850000 || nBlockHeight == 900000 || nBlockHeight == 1000000) {
    ...
    if (nBlockHeight == 19999 || nBlockHeight == 69999 || nBlockHeight == 109999 || nBlockHeight == 149999 || nBlockHeight == 199999 || nBlockHeight == 229999 || nBlockHeight == 259999 || nBlockHeight == 299999 || nBlockHeight == 349999 || nBlockHeight == 399999 || nBlockHeight == 499999 || nBlockHeight == 599999 || nBlockHeight == 699999 || nBlockHeight == 799999 || nBlockHeight == 849999 || nBlockHeight == 899999 || nBlockHeight == 999999) {
    ...
    if (nBlockHeight == 20201 || nBlockHeight == 70201 || nBlockHeight == 110201 || nBlockHeight == 150201 || nBlockHeight == 200201 || nBlockHeight == 230201 || nBlockHeight == 260201 || nBlockHeight == 300201 || nBlockHeight == 350201 || nBlockHeight == 400201 || nBlockHeight == 500201 || nBlockHeight == 600201 || nBlockHeight == 700201 || nBlockHeight == 800201 || nBlockHeight == 850201 || nBlockHeight == 900201 || nBlockHeight == 1000201) {
        SporkId nSporkID = sporkManager.GetSporkIDByName("SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT");
...
void CMasternodePayments::FillBlockPayee(CMutableTransaction& txCoinbase, CMutableTransaction& txCoinstake, const CBlockIndex* pindexPrev, bool fProofOfStake) const
{
    ...
    // Starting from EVO_Nodes v6.0 masternode and budgets are paid in the coinbase tx
