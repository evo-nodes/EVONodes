...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("evo_nodes"), " EVO_Nodes");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://evo_nodes.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/evo_nodes"));
    BOOST_CHECK(validateURL("https://foo.bar/evo_nodes/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.evo_nodes.com"));
