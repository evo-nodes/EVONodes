...
from test_framework.test_framework import  EVO_NodesTier2TestFramework
...
class MasternodeGovernanceBasicTest( EVO_NodesTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.evo_nodes.org/t/test-proposal",
            2,
