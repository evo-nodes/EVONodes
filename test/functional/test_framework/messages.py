...
COIN = 100000000  # 1 EVO in satoshis
...
# Objects that map to evo_nodesd objects, which can be serialized/deserialized
class CAddress:
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in evo_nodesd indicates these should be deserialized as blocks
