...
from test_framework.test_framework import  EVO_NodesTestFramework, SkipTest
...
class ZMQTest ( EVO_NodesTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that evo_nodes has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("evo_nodesd has not been built with zmq enabled.")
