...
class DIP3Test( EVO_NodesTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 EVO) to the operator, and (2 * 2.7 EVO) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid  EVO_Nodes address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid  EVO_Nodes address InvalidPayee", controller.protx_update_registrar,
