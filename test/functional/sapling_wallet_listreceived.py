...
class ListReceivedTest ( EVO_NodesTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 EVO.
        ...
        # Send 1 EVO to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 EVO sending them all (fee is 0.1 EVO)
        ...
        # Confirm transaction (2 EVO from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 EVO, send 0.6 EVO + 0.05 EVO fee
