...
class NetTest( EVO_NodesTestFramework):
    ...
    def _test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(ipv6_addr, 18050)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 18050)
