...
class BudgetProposalTest( EVO_NodesTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid  EVO_Nodes address")
        assert_raises_rpc_error(-5, "Invalid  EVO_Nodes address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of %.8f is less than minimum 10 EVO allowed" % invalid_amt, self.nodes[0].preparebudget,
