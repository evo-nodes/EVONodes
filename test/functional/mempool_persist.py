...
By default, evo_nodesd will dump mempool on shutdown and
...
class MempoolPersistTest( EVO_NodesTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent evo_nodesd from writing mempool.dat to disk. Verify that `savemempool` fails")
