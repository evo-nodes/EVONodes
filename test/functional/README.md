...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the  EVO_NodesTestFramwork, place overrides for the
...
with the evo_nodesd(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a evo_nodesd.  `P2PInterface`
...
Basic code to support P2P connectivity to a evo_nodesd.
