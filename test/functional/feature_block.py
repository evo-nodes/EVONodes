...
class FullBlockTest( EVO_NodesTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure evo_nodesd isn't accepting b26
        ...
        # Extend the b28 chain to make sure evo_nodesd isn't accepting b28
        ...
        #  EVO_Nodes: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the evo_nodes code has custom code which does so);
