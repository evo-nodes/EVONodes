...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "qt/evo_nodes/evo_nodesgui -> qt/evo_nodes/qtutils -> qt/evo_nodes/evo_nodesgui"
    "qt/evo_nodes/qtutils -> qt/evo_nodes/snackbar -> qt/evo_nodes/qtutils"
    "sapling/saplingscriptpubkeyman -> wallet/wallet -> sapling/saplingscriptpubkeyman"
    "spork -> sporkdb -> spork"
    "spork -> validation -> spork"
    "txmempool -> validation -> txmempool"
    "validation -> validationinterface -> validation"
    "validation -> zevo/zevomodule -> validation"
