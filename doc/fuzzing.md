...
To build  EVO_Nodes Core using AFL instrumentation (this assumes that the
...
with certain assembly code from  EVO_Nodes Core's code. See [developer notes on sanitizers](https://github.com/ EVO_Nodes-Project/ EVO_Nodes/blob/master/doc/developer-notes.md#sanitizers)
