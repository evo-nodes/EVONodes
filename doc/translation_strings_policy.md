...
This document provides guidelines for internationalization of the  EVO_Nodes Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to  EVO_Nodes network</source>
        <translation>
            <numerusform>%n active connection to  EVO_Nodes network</numerusform>
            <numerusform>%n active connections to  EVO_Nodes network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `evo_nodes_en.ts` remains unchanged.
