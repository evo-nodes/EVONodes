...
def main():
    ...
    # Filter out hosts with multiple evo_nodes ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple evo_nodes ports' % (ip_stats(ips)), file=sys.stderr)
