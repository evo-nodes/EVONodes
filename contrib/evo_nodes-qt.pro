...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/evo_nodes-cli.cpp \
           src/evo_nodes-tx.cpp \
           src/evo_nodes.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/evo_nodes.qrc src/qt/evo_nodes_locale.qrc

TRANSLATIONS += src/qt/locale/evo_nodes_bg.ts \
                src/qt/locale/evo_nodes_de.ts \
                src/qt/locale/evo_nodes_en.ts \
                src/qt/locale/evo_nodes_es.ts \
                src/qt/locale/evo_nodes_fi.ts \
                src/qt/locale/evo_nodes_fr.ts \
                src/qt/locale/evo_nodes_it.ts \
                src/qt/locale/evo_nodes_ja.ts \
                src/qt/locale/evo_nodes_pl.ts \
                src/qt/locale/evo_nodes_pt.ts \
                src/qt/locale/evo_nodes_ru.ts \
                src/qt/locale/evo_nodes_sk.ts \
                src/qt/locale/evo_nodes_sv.ts \
                src/qt/locale/evo_nodes_vi.ts \
                src/qt/locale/evo_nodes_zh_CN.ts \
                src/qt/locale/evo_nodes_zh_TW.ts
