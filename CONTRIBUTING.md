Contributing to EVO_Nodes Core
============================

The EVO_Nodes Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/evo_nodes-project/evo_nodes/blob/master/doc/translation_process.md)
...
The following applies to code changes to the EVO_Nodes Core project, and is not to be
confused with overall EVO_Nodes Network Protocol consensus changes.

Whether a pull request is merged into EVO_Nodes Core rests with the project merge
...
Patches that change EVO_Nodes consensus rules are considerably more involved than
...
Where a patchset proposes to change the EVO_Nodes consensus, it must have been
...
The project leader is the release manager for each EVO_Nodes Core release.
